...
class CategoryDetailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.lbl_title.text = title_category_str
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(CategoryDetailVC.didPlayToEnd), name: .AVPlayerItemDidPlayToEndTime, object: nil)
    }
    ...
    func songlistsLoad()
    {
        ...
        let typevalue = "CATEGORY_RINGTONES"
        let params = ["type"        :  typevalue,
                      "categoryid"  :  self.category_id] as [String : AnyObject]
...
extension CategoryDetailVC: UITableViewDelegate, UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if self.array_songlist.count > 0
        {
            ...
            cell.lbl_audio_category.text = title_category_str
            
            let img_audio_play = Utills.getAudioplaybgIcon(Int(self.category_id)!)
...
extension CategoryDetailVC: AudiolistCellDelegate
{
